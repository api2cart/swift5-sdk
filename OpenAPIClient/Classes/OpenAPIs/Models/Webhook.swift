...
public struct Webhook: Codable, JSONEncodable, Hashable {
    ...
    public var filteringConditions: AnyCodable?
    public var additionalFields: AnyCodable?
    public var customFields: AnyCodable?

    public init(id: Int? = nil, label: String? = nil, storeId: String? = nil, langId: String? = nil, active: Bool? = nil, callback: String? = nil, fields: String? = nil, responseFields: String? = nil, createdAt: String? = nil, updatedAt: String? = nil, entity: String? = nil, action: String? = nil, filteringConditions: AnyCodable? = nil, additionalFields: AnyCodable? = nil, customFields: AnyCodable? = nil) {
        self.id = id
        self.label = label
