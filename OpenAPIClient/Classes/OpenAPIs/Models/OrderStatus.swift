...
public struct OrderStatus: Codable, JSONEncodable, Hashable {
    ...
    public init(id: String? = nil, name: String? = nil, history: [OrderStatusHistoryItem]? = nil, refundInfo: OrderStatusRefund? = nil, additionalFields: AnyCodable? = nil, customFields: AnyCodable? = nil) {
        self.id = id
        self.name = name
