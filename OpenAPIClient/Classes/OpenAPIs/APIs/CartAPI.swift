...
open class CartAPI {
    ...
    @discardableResult
    open class func cartBridge(apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: CartBridge200Response?, _ error: Error?) -> Void)) -> RequestTask {
        return cartBridgeWithRequestBuilder().execute(apiResponseQueue) { result in
            switch result {
     ...
     */
    @available(*, deprecated, message: "This operation is deprecated.")
    open class func cartBridgeWithRequestBuilder() -> RequestBuilder<CartBridge200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<CartBridge200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    @available(*, deprecated, message: "This operation is deprecated.")
    @discardableResult
    open class func cartClearCache(cacheType: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: CartClearCache200Response?, _ error: Error?) -> Void)) -> RequestTask {
        return cartClearCacheWithRequestBuilder(cacheType: cacheType).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
     ...
     */
    @available(*, deprecated, message: "This operation is deprecated.")
    open class func cartClearCacheWithRequestBuilder(cacheType: String) -> RequestBuilder<CartClearCache200Response> {
        ...
        var localVariableUrlComponents = URLComponents(string: localVariableURLString)
        localVariableUrlComponents?.queryItems = APIHelper.mapValuesToQueryItems([
            "cache_type": (wrappedValue: cacheType.encodeToJSON(), isExplode: true),
        ])
        ...
        let localVariableRequestBuilder: RequestBuilder<CartClearCache200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    @available(*, deprecated, message: "This operation is deprecated.")
    @discardableResult
    open class func cartConfig(params: String? = nil, exclude: String? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: CartConfig200Response?, _ error: Error?) -> Void)) -> RequestTask {
        return cartConfigWithRequestBuilder(params: params, exclude: exclude).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
     ...
     */
    @available(*, deprecated, message: "This operation is deprecated.")
    open class func cartConfigWithRequestBuilder(params: String? = nil, exclude: String? = nil) -> RequestBuilder<CartConfig200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<CartConfig200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    @available(*, deprecated, message: "This operation is deprecated.")
    @discardableResult
    open class func cartConfigUpdate(cartConfigUpdate: CartConfigUpdate, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: CartConfigUpdate200Response?, _ error: Error?) -> Void)) -> RequestTask {
        return cartConfigUpdateWithRequestBuilder(cartConfigUpdate: cartConfigUpdate).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
     ...
     */
    @available(*, deprecated, message: "This operation is deprecated.")
    open class func cartConfigUpdateWithRequestBuilder(cartConfigUpdate: CartConfigUpdate) -> RequestBuilder<CartConfigUpdate200Response> {
        let localVariablePath = "/cart.config.update.json"
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: cartConfigUpdate)
    ...
    @available(*, deprecated, message: "This operation is deprecated.")
    @discardableResult
    open class func cartCreate(cartCreate: CartCreate, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: AccountCartAdd200Response?, _ error: Error?) -> Void)) -> RequestTask {
        return cartCreateWithRequestBuilder(cartCreate: cartCreate).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
     ...
     */
    @available(*, deprecated, message: "This operation is deprecated.")
    open class func cartCreateWithRequestBuilder(cartCreate: CartCreate) -> RequestBuilder<AccountCartAdd200Response> {
        let localVariablePath = "/cart.create.json"
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: cartCreate)
    ...
    @available(*, deprecated, message: "This operation is deprecated.")
    @discardableResult
    open class func cartDisconnect(deleteBridge: Bool? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: CartDisconnect200Response?, _ error: Error?) -> Void)) -> RequestTask {
        return cartDisconnectWithRequestBuilder(deleteBridge: deleteBridge).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
     ...
     */
    @available(*, deprecated, message: "This operation is deprecated.")
    open class func cartDisconnectWithRequestBuilder(deleteBridge: Bool? = nil) -> RequestBuilder<CartDisconnect200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<CartDisconnect200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    @available(*, deprecated, message: "This operation is deprecated.")
    @discardableResult
    open class func cartList(apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: CartList200Response?, _ error: Error?) -> Void)) -> RequestTask {
        return cartListWithRequestBuilder().execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
     ...
     */
    @available(*, deprecated, message: "This operation is deprecated.")
    open class func cartListWithRequestBuilder() -> RequestBuilder<CartList200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<CartList200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
